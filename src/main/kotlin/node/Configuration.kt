...
object Configuration {
   ...
   * be thrown.
   */
  inline fun get(path: String, def: (() -> Any)): Any {
    return get(path) ?: def()
  }
   ...
   */
  inline fun string(path: String, def: (() -> String)): String {
    return get(path, def) as String
  }

  inline fun integer(path: String, def: (() -> String)): Int {
